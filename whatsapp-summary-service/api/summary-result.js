...
module.exports = async function handler(req, res) {
  ...
  const { phoneNumber, chatName, summary, success, error } = req.body;
  ...
  try {
    ...
    await pusher.trigger(channelName, "summary-result", {
      chatName,
    ...
    console.log(`summary-result triggered for channel: ${channelName}`);
